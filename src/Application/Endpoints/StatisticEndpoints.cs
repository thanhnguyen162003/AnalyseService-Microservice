...
public class StatisticEndpoints : ICarterModule
{
    public void AddRoutes(IEndpointRouteBuilder app)
    {
        ...
        group.MapGet("testdb", TestDB).WithName(nameof(TestDB));
    ...
    public static async Task<IResult> TestDB(string Type, int Amount, bool IsCount, ISender sender, CancellationToken cancellationToken)
    {
